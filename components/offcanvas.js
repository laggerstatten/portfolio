                        ...
                        <ul class="nav dropdown-toggle-start-icon flex-column">
                            ...
                            <li class="collapse" id="home-dropdown-collapse">
                                <ul class="nav flex-column w-100 pb-4 pe-0 pe-lg-5">
                                    <li class="nav-item"> <a class="nav-link px-0 text-body" href="/portfolio/index.html#featuredProjects">Featured Projects</a> </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item d-block d-md-flex mb-2">
                                <h5 class="display-5 mb-0"><a class="nav-link text-light-stroke" href="/portfolio/portfolio.html">Portfolio</a></h5>
                                <p class="align-self-center mt-0 mt-md-5">— projects from the last 5 years</p>
                            </li>

                            <!-- Nav item -->
                            <li class="nav-item d-block d-md-flex mb-2">
                                <h5 class="display-5 mb-0"><a class="nav-link text-light-stroke" href="/portfolio/blog-minimal.html">Blog</a></h5>
                                <p class="align-self-center mt-0 mt-md-5">— thoughts on design</p>
                            </li>

                            <!-- Nav item -->
                            <li class="nav-item d-block d-md-flex mb-2">
                                <h5 class="display-5 mb-0"><a class="nav-link text-light-stroke" href="/portfolio/design_timeline.html">Design Timeline</a></h5>
                                <p class="align-self-center mt-0 mt-md-5">— my time at LSC</p>
                            </li>

                            <!-- Nav item -->
                            <li class="nav-item d-block d-md-flex mb-2">
                                <h5 class="display-5 mb-0"><a class="nav-link text-light-stroke" href="/portfolio/aboutme.html">About Me</a></h5>
                                <p class="align-self-center mt-0 mt-md-5">— who am I?</p>
                            </li>

                            <!-- Nav item -->
                            <li class="nav-item d-block d-md-flex mb-2">
                                <h5 class="display-5 mb-0"><a class="nav-link text-light-stroke" href="/portfolio/contact.html">Contact Me</a></h5>
